...
version(Legacy)
{
    version(DLL)
	{
		...
		export enum Axis { /**The x-axis.*/ x, /**The y-axis.*/y, /**The z-axis.*/ z}
		///Enumeration for representing a plane.
		export enum Plane { /**Plane xy*/ xy, /**Plane xz*/ xz, /**Plane zy*/ zy}
		...
		package mixin template __mov__general__(string func)
		{
		  ...
		  Returns:
		  none*/
		pragma(inline, true) export void move(Point moveto, uint tbf, ref shared Skeleton tomove, real speed)
		{
		  ...
		  Returns: none*/
		pragma(inline, true) export void accMove(Point moveto, uint tbf, shared ref Skeleton tomove, real speed, real accdec = 0)
		{
		  ...
		  Params:
		   ...
		   Returns: none*/
		pragma(inline) export void decMove(Point moveto, uint tbf, shared ref Skeleton tomove, real speed, real accdec = 0)
		{
		...
		export struct Collision
		{
		  ...
		  */
		export Collision detectCollision(shared Skeleton[] towatch, shared Skeleton skele, in real time = 0)
			in	{
		...
		Returns: none.*/
		pragma(inline, true) export void affectByGravity(shared Skeleton[] towatch, ref shared Skeleton skele, in uint tbf, Gravity gravity)
		{
		...
		*/
		export void rotate(in real degrees, in Plane plane, in ulong frames, in ulong rate, ref shared Skeleton skele)
		{
			ulong fcounter = 0;
...
version(Standard)
{
 static assert(false, "ERROR:  dutils.physics is not compatible with the standard version of this package.");
}