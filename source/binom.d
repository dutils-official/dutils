...
public class OutBinom(X)  if(is(X : real))	{ //Class for the output of functions involving binomials
	...
	public:
		...
		/**
		  * OutBinom.result returns the result generated by the binomial theroem.
		  * Params:
		  * none
		  * Returns:
		  * Result generated by calling InBinom.BinomEqu()
		*/
		pure X result() const @property	{
			return this.sum_of_outvals;
		}
		/**
		  * OutBinom.seperatedVals returns all of the values that InBinom.BinomEqu() spews out without summing it all.
		  * Params:
		  * none
		  * Returns:
		  * All the values generated by InBinom.BinomEqu() beffore summing.
		*/
		pure X[] seperatedvals() const @property	{
			return this.outvals.dup;
		}
		/**
		  * OutBinom.coefficients returns all of the coefficiants generated by InBionm.BinomEqu() as an array.
		  * Params:
		  * none
		  * Returns:
		  * All of the coefficients generated by InBinom.BinomEqu() as an array.
		*/
		pure uint[] coefficients() const @property	{
			return this.coefficiants.dup;
		}
		/**
		  * OutBinom.xval returns the value of x.
		  * Params:
		  * none
		  * Returns:
		  * Value of 'OutBinom.x.'
		*/
		pure X xval() const @property	{
			return this.x;
		}
		/**
		  * OutBinom.yval returns the value of y.
		  * Params:
		  * none
		  * Returns:
		  * Value of 'OutBinom.y.'
		*/
		pure X yval() const @property	{
			return this.y;
		}
		/**
		  * OutBinom.nval returns the value of n.
		  * Params:
		  * none
		  * Returns:
		  * Value of 'OutBinom.n' as in 'n' Choose 'k.'
		*/
		pure uint nval() const @property	{
			return this.n;
		}	
}
/**********************************************************************
